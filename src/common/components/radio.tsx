...
const base = [
  ...
  // Border
  'border border-slate-950/15 group-data-[checked]:border-transparent group-data-[checked]:group-data-[hover]:border-transparent group-data-[hover]:border-slate-950/30 group-data-[checked]:bg-[--radio-checked-border]',
  ...
  '[--radio-indicator:transparent] group-data-[checked]:[--radio-indicator:var(--radio-checked-indicator)] group-data-[checked]:group-data-[hover]:[--radio-indicator:var(--radio-checked-indicator)] group-data-[hover]:[--radio-indicator:theme(colors.slate.900/10%)]',
  // Indicator color (dark mode)
  'dark:group-data-[checked]:group-data-[hover]:[--radio-indicator:var(--radio-checked-indicator)] dark:group-data-[hover]:[--radio-indicator:theme(colors.slate.700)]',
  // Focus ring
  'group-data-[focus]:outline group-data-[focus]:outline-2 group-data-[focus]:outline-offset-2 group-data-[focus]:outline-blue-500',
  // Disabled state
  'group-data-[disabled]:opacity-50',
  'group-data-[disabled]:border-slate-950/25 group-data-[disabled]:bg-slate-950/5 group-data-[disabled]:[--radio-checked-indicator:theme(colors.slate.950/50%)] group-data-[disabled]:before:bg-transparent',
...
const colors = {
  'dark/slate': [
    '[--radio-checked-bg:theme(colors.slate.900)] [--radio-checked-border:theme(colors.slate.950/90%)] [--radio-checked-indicator:theme(colors.white)]',
    'dark:[--radio-checked-bg:theme(colors.slate.600)]',
  ],
  'dark/white': [
    '[--radio-checked-bg:theme(colors.slate.900)] [--radio-checked-border:theme(colors.slate.950/90%)] [--radio-checked-indicator:theme(colors.white)]',
    'dark:[--radio-checked-bg:theme(colors.white)] dark:[--radio-checked-border:theme(colors.slate.950/15%)] dark:[--radio-checked-indicator:theme(colors.slate.900)]',
  ],
  white:
    '[--radio-checked-bg:theme(colors.white)] [--radio-checked-border:theme(colors.slate.950/15%)] [--radio-checked-indicator:theme(colors.slate.900)]',
  dark: '[--radio-checked-bg:theme(colors.slate.900)] [--radio-checked-border:theme(colors.slate.950/90%)] [--radio-checked-indicator:theme(colors.white)]',
  slate: '[--radio-checked-indicator:theme(colors.white)] [--radio-checked-bg:theme(colors.slate.600)] [--radio-checked-border:theme(colors.slate.700/90%)]',
