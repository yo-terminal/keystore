  ...
  return (
    <>
      <div className="mx-auto max-w-3xl">
        <Heading>Welcome to <span className="font-light tracking-wide text-yellow-400">Keystore</span></Heading>
        ...
        <div className="flex gap-4 items-center flex-wrap">
          <ConnectButton className="!bg-slate-600 !text-white !py-2.5 !px-10" />
